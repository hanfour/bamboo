...
export function HamburgerButton() {
  ...
  return (
    <button
      ...
      className="-ml-2 inline-flex h-9 w-9 items-center justify-center rounded-md text-zinc-700 transition-colors hover:bg-bamboo-100 hover:text-zinc-900 lg:hidden dark:text-zinc-300 dark:hover:bg-bamboo-900/30 dark:hover:text-zinc-100"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
